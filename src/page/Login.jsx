                ...
                <div className="flex bg-gray-100 rounded-2xl shadow-lg dark:bg-transparent dark:shadow-2xl">
                    ...
                    <div className="sm:w-1/2 px-16 mb-5">
                        ...
                        <form className="flex flex-col gap-2">
                            <input className="p-2 duration-300 ring-1 ring-violet-600 mt-8 rounded-xl border hover:shadow-lg" type="email" name="email" placeholder="E-mail" />
                            <input className="p-2 duration-300 ring-1 ring-violet-500 mt-7 rounded-xl border hover:shadow-lg" type="password" name="password" placeholder="Password" />
